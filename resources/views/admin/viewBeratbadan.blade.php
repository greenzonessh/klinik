        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">Berat Badan Sehat</li>
                </ul><!-- /.breadcrumb -->
            </div>
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form id="id-message-form" action="beratbadansehat" class="hide form-horizontal message-form col-xs-12" enctype="multipart/form-data" method="POST">
                            {{csrf_field()}}
                            {{method_field('post')}}
                            <div class="tab-content no-border no-padding">
                                <div id="inbox" class="tab-pane in active">
                                        ...
                                        <div id="id-message-new-navbar" class="hide message-navbar clearfix">
                                            <div class="message-bar">
                                                <div class="message-toolbar">
                                                    ...
                                                    <a href="beratbadansehat" type="button" class="btn btn-xs btn-white btn-primary">
                                                        <i class="ace-icon fa fa-times bigger-125 orange2"></i>
                                                        <span class="bigger-110">Batal</span>
                                                    </a>
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="hidden-sm hidden-xs action-buttons">
                                                    ...
                                                    <a class="red" href="deletepostingberatbadansehat/{{$posting->id_posting}}">
                                                ...
                                                <div class="hidden-md hidden-lg">
                                                    <div class="inline pos-rel">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                                            ...
                                                            <li>
                                                                <a href="deletepostingberatbadansehat/{{$posting->id_posting}}" class="tooltip-error" data-rel="tooltip" title="Delete">
																				<span class="red">
