            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form id="id-message-form" action="../edit/{{$postingan->id_posting}}" class="show form-horizontal message-form col-xs-12" enctype="multipart/form-data" method="POST">
                            {{csrf_field()}}
                                        ...
                                        <div id="id-message-new-navbar" class="message-navbar clearfix">
                                            <div class="message-bar">
                                                <div class="message-toolbar">
                                                    ...
                                                    <a href="../../../admin" type="button" class="btn btn-xs btn-white btn-primary">
                            ...
                            <div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6 col-xs-12">
                                        <div class="input-icon block col-xs-12 no-padding">
                                            <input maxlength="100" type="text" class="col-xs-12" name="judul_posting" id="form-field-subject" placeholder="Judul Postingan" value="{{$postingan->judul_posting}}" required />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea name="isi_posting" id="editorposting" cols="10" rows="5" required>{{$postingan->isi_posting}}</textarea>
