            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form id="id-message-form" action="jadwaldokter/{{$jadwal[0]->id_jadwal}}" class="show form-horizontal message-form col-xs-12" enctype="multipart/form-data" method="POST">
                            {{csrf_field()}}
                            ...
                            <div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea name="isi_jadwal" id="editorposting" cols="10" rows="5" required>{{$jadwal[0]->isi_jadwal}}</textarea>
