        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">Aktivitas Fisik</li>
                </ul><!-- /.breadcrumb -->
            </div>
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form id="id-message-form" action="aktivitasfisik" class="hide form-horizontal message-form col-xs-12" enctype="multipart/form-data" method="POST">
                            {{csrf_field()}}
                            {{method_field('post')}}
                            <div class="tab-content no-border no-padding">
                                <div id="inbox" class="tab-pane in active">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="hidden-sm hidden-xs action-buttons">
                                                    ...
                                                    <a class="red" href="deletepostingaktivitasfisik/{{$posting->id_posting}}">
                                                ...
                                                <div class="hidden-md hidden-lg">
                                                    <div class="inline pos-rel">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                                            ...
                                                            <li>
                                                                <a href="deletepostingaktivitasfisik/{{$posting->id_posting}}" class="tooltip-error" data-rel="tooltip" title="Delete">
																				<span class="red">
