...
<div id="pm_layout_wrapper" class="pm-full-mode"><!-- Use wrapper for wide or boxed mode -->
        ...
        <div class="container">
            <div class="row">
                ...
                <form action="#" method="post">
                    ...
                    <div class="col-lg-12 pm-clear-element" style="padding-top:200px;">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <p class="pm-post-title">Edukasi Klub</p>
	...
	<div class="isotope-item size1 col-lg-4 col-md-4 col-sm-12 col-xs-12">
                ...
                <div class="pm-gallery-post-item-container" style="background-image:url({{asset('images/edukasiklub/1.jpg')}});">
                    ...
                    <div class="pm-gallery-post-item-info-container">
                        ...
                        <div class="pm-gallery-item-excerpt">
                            ...
                            <ul class="pm-gallery-item-btns">
                                ...
                                <li><a class="fa fa-camera lightbox" data-rel="prettyPhoto[gallery]" href="{{asset('images/edukasiklub/1.jpg')}}"></a></li>
			...
			<div class="isotope-item size1 col-lg-4 col-md-4 col-sm-12 col-xs-12">
                ...
                <div class="pm-gallery-post-item-container" style="background-image:url({{asset('images/edukasiklub/2.jpg')}});">
                    ...
                    <div class="pm-gallery-post-item-info-container">
                        ...
                        <div class="pm-gallery-item-excerpt">
                            ...
                            <ul class="pm-gallery-item-btns">
                                ...
                                <li><a class="fa fa-camera lightbox" data-rel="prettyPhoto[gallery]" href="{{asset('images/edukasiklub/2.jpg')}}"></a></li>
			...
			<div class="isotope-item size1 col-lg-4 col-md-4 col-sm-12 col-xs-12">
                ...
                <div class="pm-gallery-post-item-container" style="background-image:url({{asset('images/edukasiklub/4.jpg')}});">
                    ...
                    <div class="pm-gallery-post-item-info-container">
                        ...
                        <div class="pm-gallery-item-excerpt">
                            ...
                            <ul class="pm-gallery-item-btns">
                                ...
                                <li><a class="fa fa-camera lightbox" data-rel="prettyPhoto[gallery]" href="{{asset('images/edukasiklub/4.jpg')}}"></a></li>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="pm-single-post-article">
                    <p><span style="font-family:&quot;Times New Roman&quot;,&quot;serif&quot;; font-size:12.0pt">Edukasi Klub Prolanis adalah kegiatan untuk meningkatkan pengetahuan kesehatan dalam upaya memulihkan penyakit dan mencegah timbulnya kembali penyakit serta meningkatkan status kesehatan bagi peserta Prolanis. Edukasi klub dilakukan setiap 1 bulan sekali di Klinik Rawat Inap dr. M. Suherman yang disampaikan oleh tenaga kesehatan Klinik Rawat Inap dr. M. Suherman. Pelaksanaan edukasi dilakukan setelah senam Prolanis dan pemantauan kesehatan (cek laboratorium dan pengukuran tekanan darah). </span></p>
