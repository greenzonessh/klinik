...
<head>
    ...
    <!-- Isotope -->
    <link rel="stylesheet" type="text/css" href="{{asset('js/isotope/isotope.css')}}" />
    <!-- Isotope -->
...
<div id="pm_layout_wrapper" class="pm-full-mode"><!-- Use wrapper for wide or boxed mode -->
            ...
            <div class="row">
                ...
                <form action="login" method="post">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <input name="username" type="text" class="pm-request-appointment-form-textfield" placeholder="Username" required>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <input name="password" type="password" class="pm-request-appointment-form-textfield" placeholder="Password" required>
                    </div>
                    <div class="col-lg-12 pm-clear-element" style="padding-top:20px;">
                        ...
                        <p class="pm-appointment-form-notice">Silahkan Login</p>                            <a href="#" class="pm-appointment-form-close" id="pm-close-appointment-form"><i class="fa fa-close"></i> Close</a>
                    </div>
                        ...
                        <ul class="sf-menu pm-nav">
                            ...
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li><a href="unitpelayanan">Unit Pelayanan</a></li>
                            ...
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li><a href="pentingnyacrmhipertensi">Upaya Pemeliharaan Hipertensi</a></li>
                                </ul>
                            </li>
                            <li>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <p class="pm-page-title">Senam Prolanis</p>
                        <p class="pm-page-message">Dokumentasi Pelaksanaan Senam Prolanis</p>
    ...
    <!-- PANEL 1 -->
    <div class="container pm-containerPadding-top-40 pm-containerPadding-bottom-20">

        <div class="row">
            <div class="col-lg-12">


                    <p><span style="font-family:&quot;Times New Roman&quot;,&quot;serif&quot;; font-size:12.0pt">Senam prolanis adalah kegiatan senam bersama yang dilakukan di Halaman Klinik Rawat Inap dr. M. Suherman dengan peserta prolanis setiap hari sabtu. Peserta Prolanis adalah pasien hipertensi yang memiliki asuransi BPJS Kesehatan dimana fasilitas pelayanan kesehatan tingkat 1 terdaftar di Klinik Rawat Inap dr. M. Suherman. Pasien yang terdiagnosa hipertensi setelah dilakukan pemeriksaan oleh dokter dan berusia &gt;35 tahun, maka pasien tersebut berhak mengikuti kegiatan Prolanis. Kesediaan mengikuti kegiatan Prolanis dibuktikan melalui pengisian surat pernyataan anggota Prolanis.</span></p>
    ...
    <div class="container pm-containerPadding-top-20 pm-containerPadding-bottom-30">
        ...
        <div class="row isotope" id="gallery-posts">
            ...
            <div class="isotope-item size1 col-lg-4 col-md-4 col-sm-12 col-xs-12">
                ...
                <div class="pm-gallery-post-item-container" style="background-image:url({{asset('images/senamprolanis/1.jpg')}});">
                    ...
                    <div class="pm-gallery-post-item-info-container">
                        ...
                        <div class="pm-gallery-item-excerpt">
                            ...
                            <ul class="pm-gallery-item-btns">
                                ...
                                <li><a class="fa fa-camera lightbox" data-rel="prettyPhoto[gallery]" href="{{asset('images/senamprolanis/1.jpg')}}"></a></li>
            ...
            <div class="isotope-item size2 col-lg-4 col-md-4 col-sm-12 col-xs-12">
                ...
                <div class="pm-gallery-post-item-container" style="background-image:url({{asset('images/senamprolanis/2.jpg')}});">
                    ...
                    <div class="pm-gallery-post-item-info-container">
                        ...
                        <div class="pm-gallery-item-excerpt">
                            ...
                            <ul class="pm-gallery-item-btns">
                                ...
                                <li><a class="fa fa-camera lightbox" data-rel="prettyPhoto[gallery]" href="{{asset('images/senamprolanis/2.jpg')}}"></a></li>
            ...
            <div class="isotope-item size3 col-lg-4 col-md-4 col-sm-12 col-xs-12">
                ...
                <div class="pm-gallery-post-item-container" style="background-image:url({{asset('images/senamprolanis/3.jpg')}});">
                    ...
                    <div class="pm-gallery-post-item-info-container">
                        ...
                        <div class="pm-gallery-item-excerpt">
                            ...
                            <ul class="pm-gallery-item-btns">
                                ...
                                <li><a class="fa fa-camera lightbox" data-rel="prettyPhoto[gallery]" href="{{asset('images/senamprolanis/3.jpg')}}"></a></li>
            ...
            <div class="isotope-item size2 col-lg-4 col-md-4 col-sm-12 col-xs-12">
                ...
                <div class="pm-gallery-post-item-container" style="background-image:url({{asset('images/senamprolanis/4.jpg')}});">
                    ...
                    <div class="pm-gallery-post-item-info-container">
                        ...
                        <div class="pm-gallery-item-excerpt">
                            ...
                            <ul class="pm-gallery-item-btns">
                                ...
                                <li><a class="fa fa-camera lightbox" data-rel="prettyPhoto[gallery]" href="{{asset('images/senamprolanis/4.jpg')}}"></a></li>
            ...
            <div class="isotope-item size3 col-lg-4 col-md-4 col-sm-12 col-xs-12">
                ...
                <div class="pm-gallery-post-item-container" style="background-image:url({{asset('images/senamprolanis/5.jpg')}});">
                    ...
                    <div class="pm-gallery-post-item-info-container">
                        ...
                        <div class="pm-gallery-item-excerpt">
                            ...
                            <ul class="pm-gallery-item-btns">
                                ...
                                <li><a class="fa fa-camera lightbox" data-rel="prettyPhoto[gallery]" href="{{asset('images/senamprolanis/5.jpg')}}"></a></li>
            ...
            <div class="isotope-item size1 col-lg-4 col-md-4 col-sm-12 col-xs-12">
                ...
                <div class="pm-gallery-post-item-container" style="background-image:url({{asset('images/senamprolanis/6.jpg')}});">
                    ...
                    <div class="pm-gallery-post-item-info-container">
                        ...
                        <div class="pm-gallery-item-excerpt">
                            ...
                            <ul class="pm-gallery-item-btns">
                                ...
                                <li><a class="fa fa-camera lightbox" data-rel="prettyPhoto[gallery]" href="{{asset('images/senamprolanis/6.jpg')}}"></a></li>
            ...
            <div class="isotope-item size2 col-lg-4 col-md-4 col-sm-12 col-xs-12">
                ...
                <div class="pm-gallery-post-item-container" style="background-image:url({{asset('images/senamprolanis/7.jpg')}});">
                    ...
                    <div class="pm-gallery-post-item-info-container">
                        ...
                        <div class="pm-gallery-item-excerpt">
                            ...
                            <ul class="pm-gallery-item-btns">
                                ...
                                <li><a class="fa fa-camera lightbox" data-rel="prettyPhoto[gallery]" href="{{asset('images/senamprolanis/7.jpg')}}"></a></li>
            ...
            <div class="isotope-item size3 col-lg-4 col-md-4 col-sm-12 col-xs-12">
                ...
                <div class="pm-gallery-post-item-container" style="background-image:url({{asset('images/senamprolanis/8.jpg')}});">
                    ...
                    <div class="pm-gallery-post-item-info-container">
                        ...
                        <div class="pm-gallery-item-excerpt">
                            ...
                            <ul class="pm-gallery-item-btns">
                                ...
                                <li><a class="fa fa-camera lightbox" data-rel="prettyPhoto[gallery]" href="{{asset('images/senamprolanis/8.jpg')}}"></a></li>
            ...
            <div class="isotope-item size2 col-lg-4 col-md-4 col-sm-12 col-xs-12">
                ...
                <div class="pm-gallery-post-item-container" style="background-image:url({{asset('images/senamprolanis/9.jpg')}});">
                    ...
                    <div class="pm-gallery-post-item-info-container">
                        ...
                        <div class="pm-gallery-item-excerpt">
                            ...
                            <ul class="pm-gallery-item-btns">
                                ...
                                <li><a class="fa fa-camera lightbox" data-rel="prettyPhoto[gallery]" href="{{asset('images/senamprolanis/9.jpg')}}"></a></li>
            ...
            <div class="isotope-item size3 col-lg-4 col-md-4 col-sm-12 col-xs-12">
                ...
                <div class="pm-gallery-post-item-container" style="background-image:url({{asset('images/senamprolanis/10.jpg')}});">
                    ...
                    <div class="pm-gallery-post-item-info-container">
                        ...
                        <div class="pm-gallery-item-excerpt">
                            ...
                            <ul class="pm-gallery-item-btns">
                                ...
                                <li><a class="fa fa-camera lightbox" data-rel="prettyPhoto[gallery]" href="{{asset('images/senamprolanis/10.jpg')}}"></a></li>
            ...
            <div class="isotope-item size1 col-lg-4 col-md-4 col-sm-12 col-xs-12">
                ...
                <div class="pm-gallery-post-item-container" style="background-image:url({{asset('images/senamprolanis/11.jpg')}});">
                    ...
                    <div class="pm-gallery-post-item-info-container">
                        ...
                        <div class="pm-gallery-item-excerpt">
                            ...
                            <ul class="pm-gallery-item-btns">
                                ...
                                <li><a class="fa fa-camera lightbox" data-rel="prettyPhoto[gallery]" href="{{asset('images/senamprolanis/11.jpg')}}"></a></li>
            ...
            <div class="isotope-item size2 col-lg-4 col-md-4 col-sm-12 col-xs-12">
                ...
                <div class="pm-gallery-post-item-container" style="background-image:url({{asset('images/senamprolanis/12.jpg')}});">
                    ...
                    <div class="pm-gallery-post-item-info-container">
                        ...
                        <div class="pm-gallery-item-excerpt">
                            ...
                            <ul class="pm-gallery-item-btns">
                                ...
                                <li><a class="fa fa-camera lightbox" data-rel="prettyPhoto[gallery]" href="{{asset('images/senamprolanis/12.jpg')}}"></a></li>
            ...
            <div class="isotope-item size3 col-lg-4 col-md-4 col-sm-12 col-xs-12">
                ...
                <div class="pm-gallery-post-item-container" style="background-image:url({{asset('images/senamprolanis/13.jpg')}});">
                    ...
                    <div class="pm-gallery-post-item-info-container">
                        ...
                        <div class="pm-gallery-item-excerpt">
                            ...
                            <ul class="pm-gallery-item-btns">
                                ...
                                <li><a class="fa fa-camera lightbox" data-rel="prettyPhoto[gallery]" href="{{asset('images/senamprolanis/13.jpg')}}"></a></li>
            ...
            <div class="isotope-item size2 col-lg-4 col-md-4 col-sm-12 col-xs-12">
                ...
                <div class="pm-gallery-post-item-container" style="background-image:url({{asset('images/senamprolanis/14.jpg')}});">
                    ...
                    <div class="pm-gallery-post-item-info-container">
                        ...
                        <div class="pm-gallery-item-excerpt">
                            ...
                            <ul class="pm-gallery-item-btns">
                                ...
                                <li><a class="fa fa-camera lightbox" data-rel="prettyPhoto[gallery]" href="{{asset('images/senamprolanis/14.jpg')}}"></a></li>
            ...
            <div class="isotope-item size3 col-lg-4 col-md-4 col-sm-12 col-xs-12">
                ...
                <div class="pm-gallery-post-item-container" style="background-image:url({{asset('images/senamprolanis/15.jpg')}});">
                    ...
                    <div class="pm-gallery-post-item-info-container">
                        ...
                        <div class="pm-gallery-item-excerpt">
                            ...
                            <ul class="pm-gallery-item-btns">
                                ...
                                <li><a class="fa fa-camera lightbox" data-rel="prettyPhoto[gallery]" href="{{asset('images/senamprolanis/15.jpg')}}"></a></li>
            ...
            <div class="isotope-item size1 col-lg-4 col-md-4 col-sm-12 col-xs-12">
                ...
                <div class="pm-gallery-post-item-container" style="background-image:url({{asset('images/senamprolanis/16.jpg')}});">
                    ...
                    <div class="pm-gallery-post-item-info-container">
                        ...
                        <div class="pm-gallery-item-excerpt">
                            ...
                            <ul class="pm-gallery-item-btns">
                                ...
                                <li><a class="fa fa-camera lightbox" data-rel="prettyPhoto[gallery]" href="{{asset('images/senamprolanis/16.jpg')}}"></a></li>
