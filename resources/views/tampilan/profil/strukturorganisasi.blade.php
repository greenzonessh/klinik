...
<div id="pm_layout_wrapper" class="pm-full-mode"><!-- Use wrapper for wide or boxed mode -->
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <p class="pm-post-title">Struktur Organisasi Klinik Rawat Inap dr. M. Suherman</p>
    ...
    <div class="container pm-containerPadding-top-120 pm-containerPadding-bottom-90">
        <div class="row">
            ...
            <!--ini di isi gambarnya yah -->
            <div class="col-lg-12">

                <img lass="img-responsive" src="{{asset('images/struktur.PNG')}}" width="100%" height="50%">
