            ...
            <div class="row">
                ...
                <form action="#" method="post">
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <input name="" type="text" class="pm-request-appointment-form-textfield" placeholder="Username" required>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <input name="" type="password" class="pm-request-appointment-form-textfield" placeholder="Password" required>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <p class="pm-post-title">Apa itu Hipertensi</p>
    ...
    <div class="container pm-containerPadding-top-110 pm-containerPadding-bottom-100">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <!-- Post image -->
                <div class="pm-single-news-post" style="background-image:url({{asset('images/apaituht.jpg')}});">

                    <div class="pm-single-news-post-overlay">

                        <div class="pm-single-news-post-icon">
                            <img src="{{asset('img/news/post-icon.jpg')}}" width="33" height="41" alt="icon">
                        </div>

                        <h6 class="pm-single-news-post-title"><a href="#">HIPERTENSI</a></h6>

                        <p class="pm-single-news-post-date">01 Januari 2017</p>
                ...
                <div class="pm-single-post-article">
                    ...
                    <p><span style="color:#000000">Hipertensi&nbsp; atau tekanan&nbsp; darah&nbsp; tinggi&nbsp; adalah peningkatan&nbsp; tekanan&nbsp; darah&nbsp; sistolik lebih&nbsp; dari&nbsp; 140 mmHg dan&nbsp; tekanan&nbsp; darah&nbsp; diastolik lebih&nbsp; dari&nbsp; 90 mmHg pada&nbsp; dua&nbsp; kali pengukuran&nbsp; dengan&nbsp; selang waktu lima&nbsp; menit&nbsp; dalam keadaan cukup&nbsp; istirahat/tenang. Peningkatan tekanan darah yang berlangsung dalam jangka waktu lama (persisten) dapat menimbulkan kerusakan&nbsp; pada ginjal (gagal ginjal), jantung (penyakit jantung koroner) dan otak (menyebabkan <em>stroke</em>) bila tidak dideteksi secara dini dan mendapat pengobatan yang memadai (Pusdatin, 2014). Adapun&nbsp; klasifikasi&nbsp; hipertensi&nbsp; terbagi&nbsp; menjadi:</span></p>

                    <ol style="list-style-type:lower-alpha">
                        <li><span style="color:#000000">Berdasarkan&nbsp; penyebab</span></li>
                    </ol>

                    <ol>
                        <li><span style="color:#000000">Hipertensi&nbsp; Primer/Hipertensi Esensial</span></li>
                    </ol>

                    <p style="margin-left:42.55pt"><span style="color:#000000">Hipertensi&nbsp; yang&nbsp; penyebabnya&nbsp; tidak&nbsp; diketahui&nbsp; (idiopatik), walaupun dikaitkan dengan&nbsp; kombinasi&nbsp; faktor gaya hidup seperti kurang bergerak (inaktivitas)&nbsp; dan&nbsp; pola&nbsp; makan.&nbsp; Terjadi&nbsp; pada&nbsp; sekitar&nbsp; 90%&nbsp; penderita hipertensi.</span></p>

                    <ol start="2">
                        <li><span style="color:#000000">Hipertensi&nbsp; Sekunder/Hipertensi&nbsp; Non Esensial</span></li>
                    </ol>

                    <p style="margin-left:42.55pt"><span style="color:#000000">Hipertensi yang penyebab dan patofisiologi diketahui, sehingga dapat dikendalikan dengan obat-obatan atau pembedahan. Hipertemsi sekunder terjadi pada 10% dari seluruh penderita hipertensi. Terdapat 9 penyebab hipertensi sekunder, yaitu : ginjal, renovaskular, adrenal, aorta, neoplasma, kelainan endokrin lain, saraf, toksemia pada kehamilan, dan obat-obatan (Ej, Suwitra, &amp; Susalit, 2001:473).</span></p>

                    <ol start="2" style="list-style-type:lower-alpha">
                        <li><span style="color:#000000">Berdasarkan&nbsp; bentuk Hipertensi</span></li>
                    </ol>

                    <ol>
                        <li><span style="color:#000000">Hipertensi&nbsp; diastolik (<em>diastolic&nbsp; hypertension</em>)</span></li>
                        <li><span style="color:#000000">Hipertensi campuran&nbsp; (<em>sistole</em>&nbsp; dan <em>diastole</em> yang meninggi)</span></li>
                        <li><span style="color:#000000">Hipertensi sistolik (<em>isolated systolic&nbsp; hypertension</em>) (Pusdatin, 2014).</span></li>
                    </ol>

                    <p><span style="color:#000000">Berdasarkan Permenkes no 5 tahun 2014 tentang Panduan Praktik Klinis Dokter di Fasilitas Pelayanan Kesehatan Primer menjelaskan bahwa Faktor risiko dibedakan dalam 2 kelompok, yaitu&nbsp; kelompok yang dapat dimodifikasi dan yang tidak dapat dimodifikasi.</span></p>

                    <ol style="list-style-type:lower-alpha">
                        <li><span style="color:#000000">Faktor yang tidak dapat dimodifikasi : umur, jenis kelamin, riwayat hipertensi, penyakit kardiovaskular dalam keluarg</span></li>
                        <li><span style="color:#000000">Faktor yang dapat dimodifikasi, yaitu : riwayat pola makan (konsumsi garam berlebihan), konsumsi alkohol berlebihan, aktivitas fisik kurang, kebiasaan merokok, obesitas, dislipidemia, diabetus melitus, dan psikososial dan stress.</span></li>
                    </ol>
