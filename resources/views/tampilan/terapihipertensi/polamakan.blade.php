            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <p class="pm-post-title">Seputar Pola Makan DASH</p>
    ...
    <div class="container pm-containerPadding-top-110 pm-containerPadding-bottom-40">
        ...
        <div class="row">
            ...
            <div class="col-lg-8 col-md-8 col-sm-12">
                ...
                <!-- Blog post 1 -->
                @foreach($postingpolamakan as $posting)
                <article class="pm-column-spacing news-post">

                    <p class="pm-standalone-news-post-category"><a href="#"><span>Pola Makan DASH</span></a></p>

                    <div class="pm-standalone-news-post" style="background-image:url({{asset('images/posting/polamakandash/'.$posting->gambar_posting)}});">
