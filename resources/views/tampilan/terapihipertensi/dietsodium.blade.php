                ...
                <div class="col-lg-6 col-md-6 col-sm-12">
                    ...
                    <div class="pm-sub-menu-info">
                        ...
                        <ul class="pm-micro-navigation">
                            <!--<li><a href="#" id="pm-appointment-form-btn">List done today(Login)</a></li>-->
                        </ul>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <p class="pm-post-title">Seputar Diet Sodium</p>
    ...
    <div class="container pm-containerPadding-top-110 pm-containerPadding-bottom-40">
        ...
        <div class="row">
            ...
            <div class="col-lg-8 col-md-8 col-sm-12">
                ...
                <!-- Blog post 1 -->
                @foreach($postingdietsodium as $posting)
                <article class="pm-column-spacing news-post">

                    <p class="pm-standalone-news-post-category"><a href="#"><span>Diet Sodium</span></a></p>

                    <div class="pm-standalone-news-post" style="background-image:url({{asset('images/posting/dietsodium/'.$posting->gambar_posting)}});">
                        ...
                        <div class="pm-standalone-news-post-overlay">
                            ...
                            <h6 class="pm-standalone-news-post-title"><a href="#">{{$posting->judul_posting}}</a></h6>

                            <p class="pm-standalone-news-post-date">{{$posting->tanggal}}</p>
                    ...
                    <div class="pm-standalone-news-post-excerpt">
                        <p>{!! substr($posting->isi_posting,0,400) !!} <a href="detail/{{$posting->id_posting}}">[...]</a> </p>

                        <a href="detail/{{$posting->id_posting}}" class="pm-rounded-btn no-border pm-center-align">view post  <i class="fa fa-plus"></i></a>

                    </div>

                </article>
                @endforeach
                {!! $postingdietsodium->render() !!}
                <!-- Blog post 1 end -->
