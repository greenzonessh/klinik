            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <p class="pm-post-title">Seputar Aktifitas Fisik</p>
    ...
    <div class="container pm-containerPadding-top-110 pm-containerPadding-bottom-40">
        ...
        <div class="row">
            ...
            <div class="col-lg-8 col-md-8 col-sm-12">
                ...
                <!-- Blog post 1 -->
                @foreach($postingaktivitasfisik as $posting)
                <article class="pm-column-spacing news-post">

                    <p class="pm-standalone-news-post-category"><a href="#"><span>Aktivitas Fisik</span></a></p>

                    <div class="pm-standalone-news-post" style="background-image:url({{asset('images/posting/aktivitasfisik/'.$posting->gambar_posting)}});">
