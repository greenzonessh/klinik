        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">Lihat Anjuran</li>
                </ul><!-- /.breadcrumb -->
            </div>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="table-header">
                                    Cari nama pasien yang telah diperiksa
                                </div>
                                ...
                                <div>
                                    <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$data->kepasien->nama_pasien}}</td>
                                            <td class="hidden-480">{{$data->kepasien->jenis_kelamin}}</td>
                                            <td>{{$data->tanggal_periksa}}</td>

                                            <td>
                                                <div class="hidden-sm hidden-xs action-buttons">

                                                    <a class="blue" href="lihat/{{$data->id_pemeriksaan}}">
                                                ...
                                                <div class="hidden-md hidden-lg">
                                                    <div class="inline pos-rel">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                                            ...
                                                            <li>
                                                                <a href="lihat/{{$data->id_pemeriksaan}}" class="tooltip-success" data-rel="tooltip" title="View">
																				<span class="blue">
